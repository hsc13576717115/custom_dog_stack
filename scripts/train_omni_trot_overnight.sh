...
source_run="${CUSTOM_DOG_SOURCE_RUN:-2026-08-13_23-09-16_omni_trot_refine_v3_main}"
source_checkpoint="${CUSTOM_DOG_SOURCE_CHECKPOINT:-model_5400.pt}"
...
# Approximately 7-8 hours on the current RTX 4060 Laptop.
export CUSTOM_DOG_MAX_ITERATIONS="${CUSTOM_DOG_MAX_ITERATIONS:-11000}"
...
exec "${project_root}/scripts/train.sh" \
    --run_name "${CUSTOM_DOG_RUN_NAME:-omni_trot_overnight_v4}" \
    --resume \
    --load_run "${source_run}" \
